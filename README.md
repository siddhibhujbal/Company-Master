Here's a sample `README.md` file based on what I observed from your screenshot and your description (Java Swing + MySQL + email content showing company-related data structure):
